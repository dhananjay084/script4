...
//   /* ===============================
//      IST TIME CHECK (4:00 PM – 5:00 PM)
//   =============================== */
// function isAllowedISTTime() {
//   const now = new Date(
//     new Date().toLocaleString("en-US", { timeZone: "Asia/Kolkata" })
...
//     iframe.referrerPolicy = "no-referrer"; // 🚫 no referrer
...
//     // Fallback after 1 second if iframe didn’t load
...
(function () {
  ...
  {
    name: "NL",
    link: "https://clk.tradedoubler.com/click?p=392919&a=3422966&epi=346234",
    start: 0 * 60,    // 12:00 AM
    end: 3 * 60      // 3:00 AM
  },
  {
    name: "FR",
    link: "https://clk.tradedoubler.com/click?p=381616&a=3421025&epi=87907",
    start: 3 * 60,    // 3:00 AM
    end: 7 * 60      // 7:00 AM
  },
  {
    name: "BE",
    link: "https://clk.tradedoubler.com/click?p=392910&a=3452145&epi=0448856",
    start: 7 * 60,    // 7:00 AM
    end: 10 * 60     // 10:00 AM
  },
  {
